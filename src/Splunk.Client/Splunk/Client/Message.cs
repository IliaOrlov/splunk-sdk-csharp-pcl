namespace Splunk.Client
{
    ...
    public sealed class Message : IComparable, IComparable<Message>, IEquatable<Message>
    {
        ...
        {
            if (!(MessageType.Debug <= type && type <= MessageType.Fatal)) {  throw new ArgumentOutOfRangeException("type", "MessageType.Debug <= type && type <= MessageType.Fatal"); }
            if (text == null) {  throw new ArgumentNullException("text", "text != null"); }
