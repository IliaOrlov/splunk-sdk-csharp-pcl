...
﻿namespace Splunk.Client
{
    ...
    public class Namespace : IComparable, IComparable<Namespace>, IEquatable<Namespace>
    {
        ...
        {
            if (!(!string.IsNullOrEmpty(user))) {  throw new ArgumentException("user", "!string.IsNullOrEmpty(user)"); }
            if (!(!string.IsNullOrEmpty(app))) {  throw new ArgumentException("app", "!string.IsNullOrEmpty(app)"); }
